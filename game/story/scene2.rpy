label scene2:
    ...
    Sé que se dirige a la casa del ermitaño ese… un tipo muy extraño. 
    
    {b}No es de confiar{/b}, ¿sabe? 
    
    Se la pasa afilando su {b}Coa{/b}
    
    y hace no se qué con granos de {b}maíz{/b}. 
    
    ¿En esta época? Ya la siembra ya pasó, ¿sabe? 
    
    Escuche. 
    
    Le voy a decir la {i}verdá{/i}. 
    
    A mí también me mandaron a preguntarle por el niño
    
    pero me da mucho miedo acercármele. 
    
    Y yo decía, pos ya va un hombre valiente como usted, ¿verdad? 
    
    Pa' que necesitan de mí entonces. 
    
    Pero hagamos un trato:
    
    Yo lo encontraré de nuevo después de que vaya con el viejo, 
    y si me comparte la información que le dé {b}¡le daré esto a cambio!{/b}
    """
    ...
    Entonces ya sabe, ¿eh? Yo lo veo luego."""
